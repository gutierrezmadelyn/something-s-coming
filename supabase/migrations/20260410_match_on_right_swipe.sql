-- Migration: Match on right swipe (no mutual required)
-- Date: 2026-04-10
-- Description: Update function to create match immediately on right swipe
-- Behavior: When a user swipes right, a match is created immediately
--           so they can start chatting without waiting for mutual swipe.

-- ============================================
-- FUNCTION: check_and_create_match (UPDATED)
-- ============================================
-- Creates a match when a user swipes right.
-- No mutual swipe required - user can message immediately.
...
User can start chatting immediately after swiping right.';
